...
/**
 * Created by Lokesh on 09-06-2015.
 */
...
public class AnimationUtil {
    ...
    public static void animateHeal(RecyclerView.ViewHolder holder, boolean goesDown){

        ObjectAnimator animatorScaleX;
        int x = goesDown?100:-100;
        if(goesDown)
         animatorScaleX = ObjectAnimator.ofFloat(holder.itemView, "translationY" ,x, 0);
        else
         animatorScaleX = ObjectAnimator.ofFloat(holder.itemView, "translationY" ,x, 0);
...
//        animatorSet.start();
    ...
    public static void animateSunblind(RecyclerView.ViewHolder holder, boolean goesDown) {
        ...
        AnimatorSet animatorSet = new AnimatorSet();
        ObjectAnimator animatorTranslateY = ObjectAnimator.ofFloat(holder.itemView, "translationY", goesDown == true ? 70 : -70, 0);
        ObjectAnimator animatorRotation = ObjectAnimator.ofFloat(holder.itemView, "rotationX", goesDown == true ? -60f : 60, 0f);
        //ObjectAnimator animatorScaleX = ObjectAnimator.ofFloat(holder.itemView, "scaleX", 0.8f, 1f);
        //animatorSet.playTogether(animatorTranslateY, animatorRotation, animatorScaleX);
        animatorSet.playTogether(animatorTranslateY, animatorRotation);
